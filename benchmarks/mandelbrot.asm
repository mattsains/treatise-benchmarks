  ...
  ;i've used the comment ;REP|a|b so you can do some kind of search replace macro magic
...
function mandel
  ...
  setl mandel.output, p3 ;REP|setl|setlp
  ...
  movc r2, 0xff
  xor r1, r2
  getl p2, mandel.output ;REP|getl|getlp
  ...
  movc r3, 0xff
  xor r4, r3
  getl p3, mandel.output ;REP|getl|getlp
  getl r0 mandel.index
  setb p3, r0, r4
  addc r0, 1 ;index++
  setl mandel.index, r0
  ...
  getl p5, mandel.output ;REP|getl|getlp
  out p5
ret